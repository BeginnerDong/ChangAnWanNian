	...
	<view>
		...
		<view class="pageBox">
			...
			<view class="d-flex j-center a-center" style="margin-top: 80rpx;">
				<view class="answerTime position-relative text-center">
					...
					<view class="infor pt-2">
						<view class="font-24 color6"><span class="color2 font-weight mr-1" style="font-size: 50rpx;">贰</span>多选</view>
			...
			<view class="submitbtn" >
				<button class="btn mb-3" v-for="(item,index) in answerData" :key="index" type="button">
					<view class="btnBj"><image src="../../static/images/anti-icon.png" mode=""></image></view>
					<view class="btnTit color2">{{item}}</view>
				</button>
			</view>
			
			<view class="submitbtn mt-5 pt-3">
				<button class="btn" type="button" @click="Router.navigateTo({route:{path:'/pages/buildUp-Answer-multiSelt-Result/buildUp-Answer-multiSelt-Result'}})">
					<view class="btnBj"><image src="../../static/images/anti-icon.png" mode=""></image></view>
