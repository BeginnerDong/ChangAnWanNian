		...
		<view class="pageBox">
			...
			<view class="productList d-flex j-sb flex-wrap mx-3">
				...
				@click="Router.navigateTo({route:{path:'/pages/week-lecture-Detail/week-lecture-Detail?id='+$event.currentTarget.dataset.id}})">
					<view class="pic rounded10"><image :src="item.mainImg&&item.mainImg[0]?item.mainImg[0].url:''" mode=""></image></view>
...
<style>
	...
	.productList .item{height: auto;background-color: initial;border-radius: 0;}
	.productList .item .pic{height: 220rpx;overflow: hidden;}
	.productList .item .infor{padding: 10rpx 0 0 0;}
</style>
