	...
	<view>
		...
		<view class="pageBox">
			...
			<view class="bg-white boxShaow overflow-h mb-3 mx-3 rounded10 overflow-h">
				...
				<view class="px-3 py-3">
					...
					<view class="d-flex a-center j-sb py-3">
						<view class="editMsg rounded10"><input type="text" value="" placeholder="预约人姓名" placeholder-class="placeholder" /></view>
						<view class="editMsg rounded10"><input type="number" maxlength="11" value="" placeholder="预约人电话" placeholder-class="placeholder" /></view>
					</view>
				</view>
			</view>
			<view class="proRow mt-3 mx-3">
				<view class="item mb-3" >
					<view class="d-flex j-sb mb-3">
						<view class="pic"><image src="../../static/images/the-orderl-img1.png" mode=""></image></view>
						<view class="infor">
					...
					<view class="d-flex j-sb a-center pt-3 border-top">
						<view>优惠券</view>
						<view class="d-flex j-end a-center color6 font-26" @click="couponShow">满20减5元<image class="arrowR ml-1" src="../../static/images/the-orderl-icon.png" mode=""></image>
						</view>
					</view>
				</view>
			</view>
			...
			<view class="xqbotomBar pl-3" style="height: 100rpx;">
				...
				<view class="payBtn d-flex j-center a-center" style="width: 300rpx;height: 100rpx;">
			...
			<view class="couponShow whiteBj radius10" v-show="is_couponShow">
				<view class="d-flex j-sb px-3 py-3 border-bottom">
					...
					<view class="">优惠券</view>
					<view class="font-26 main-text-color">确定</view>
				</view>
				
				<view class="pt-1 font-26">
					<scroll-view scroll-y style="height: 340rpx;" >
						<view class="item d-flex j-sb a-center px-3 mt-4" v-for="(item,index) in couponData" :key="index" @click="couponChange(index)">
							<view>满20减5元</view>
