		...
		<scroll-view scroll-y="true" class="pageBox" :style="{top:statusBar + 'px'}">
			<view class="bg-white boxShaow overflow-h mb-3 mx-3 rounded10 overflow-h">
				...
				<view class="px-3 py-3">
					...
					<view class="d-flex a-center j-sb py-3">
						<view class="editMsg rounded10"><input type="text" v-model="addressData.name" placeholder="预约人姓名"
							 placeholder-class="placeholder" /></view>
						<view class="editMsg rounded10"><input type="number" maxlength="11" v-model="addressData.phone" placeholder="预约人电话"
							 placeholder-class="placeholder" /></view>
					</view>
				</view>
			</view>
				...
				<view class="item mb-3" v-for="item in mainData">
					...
					<view class="d-flex j-sb a-center pt-3 border-top">
						...
						<view class="d-flex j-end a-center color6 font-26" v-if="couponData.length>0&&chooseCoupon.length>0" @click="couponShow">
							...
							<image class="arrowR ml-1" src="../../static/images/the-orderl-icon.png" mode=""></image>
						</view>
					</view>
				</view>
			</view>
			...
			<view class="px-3 pt-5">
				...
				<view class="mt-2 d-flex a-center j-sb" @click="payChange('1')">
					...
					<view class="seltIcon">
						<image :src="payCurr==1?'../../static/images/the-orderl-icon4.png':'../../static/images/the-orderl-icon5.png'"
						 mode=""></image>
					</view>
				</view>
				<view class="mt-3 d-flex a-center j-sb" @click="payChange('2')">
					...
					<view class="seltIcon">
						<image :src="payCurr==2?'../../static/images/the-orderl-icon4.png':'../../static/images/the-orderl-icon5.png'"
						 mode="">
					</view>
				</view>
			</view>
			...
			<view class="xqbotomBar pl-3" style="height: 100rpx;">
				...
				<button class="payBtn d-flex j-center a-center" style="width: 300rpx;height: 100rpx;margin: 0;border-radius: 0;"
				 open-type="getUserInfo" @getuserinfo="Utils.stopMultiClick(submit)">
					<view class="payBtnBj">
						<image src="../../static/images/the-orderl-icon3.png" mode=""></image>
					</view>
			...
			<view class="couponShow whiteBj radius10" v-show="is_couponShow">
				...
				<scroll-view scroll-y="true" style="height: 400rpx;">
					<view class="pt-1 font-26">
						<view class="item d-flex j-sb a-center px-3 mt-3" v-for="(item,index) in couponData" :key="index" @click="couponChange(index)">
							<view>抵扣券{{item.value}}元</view>
							<view class="seltIcon">
								<image :src="couponCurr==index?'../../static/images/the-orderl-icon4.png':'../../static/images/the-orderl-icon5.png'"
								 mode=""></image>
							</view>
						</view>
					</view>
								...
								if (payData == 1) {
									...
									setTimeout(function() {
										self.$Router.redirectTo({
											route: {
												path: '/pages/user-CourseOrder/user-CourseOrder'
											}
										})
									}, 1000);
								} else {
