	...
	<view>
		...
		<view class="pageBox">
			...
			<view class="mx-4 d-flex a-center j-center">
				<view class="fillInBox position-relative">
					<view class="position-absoluteXY"><image src="../../static/images/anti-icon5.png" mode=""></image></view>
					<view class="infor">
						<textarea value="" placeholder="填写答案" placeholder-class="placeholder" />
					</view>
				</view>
			...
			<view class="submitbtn mt-5" >
				<button class="btn mb-3"  type="button" @click="Router.navigateTo({route:{path:'/pages/buildUp-Answer-fillIn-Result/buildUp-Answer-fillIn-Result'}})" >
