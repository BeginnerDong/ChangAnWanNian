	...
	<view>
		...
		<view class="pageBox">
				...
				<view class="proRow ">
					<view class="item mb-3 bg-white">
						...
						<view class="pb-3 d-flex a-center j-sb font-26">
							<view>核销码：</view>
							<view class="hxEwm"  @click="hxEwmShow"><image src="../../static/images/zhoumo-img6.png" mode=""></image></view>
						</view>
					</view>
				</view>
			</view>
			...
			<view class="hxEwmShow" v-show="is_hxEwmShow">
				<view><image class="ewm" src="../../static/images/zhoumo-img7.png" mode=""></image></view>
...
<style>
	...
	.topNavFix{width: 100%;height: 80rpx;position: fixed;top:71px;right: 0;left: 0;box-sizing: border-box;z-index: 22;}
	...
	.hxEwmShow .ewm{width: 420rpx;height: 420rpx;display: block; margin: 0 auto;}
	.closeBtn{background: rgba(0,0,0,0.5);}
</style>
