		...
		<view  @scrolltolower="Bottom" class="pageBox pb-4" :style="{marginTop:44+statusBar + 'px'}">
			...
			<view class="integral mx-3">
				<view class="item rounded10 overflow-h position-relative mb-3 px-3 py-4" v-for="(item,index) in mainData" :key="index">
					<view class="position-absoluteXY" v-if="item.use_step==1">
						<image src="../../static/images/integral-malli-img.png" mode=""></image>
					</view>
					<view class="position-absoluteXY" v-if="item.use_step==2">
						<image src="../../static/images/couponal-icon1.png" mode=""></image>
					</view>
					<view class="infor d-flex a-center j-sb main-text-color">
						...
						<view class="rr d-flex j-center a-center" v-if="item.use_step==2">
							<view class="overdue">
								<image src="../../static/images/couponal-icon.png" mode=""></image>
							</view>
						</view>
					</view>
				</view>
